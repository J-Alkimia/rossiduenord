...
@section('content')
    ...
    <div class="nav_bonus">
        <span class="frame ">Dati di Progetto</span>
        ...
        <div class="mt-5">
            ...
            <div class="d-flex">
                ...
                <div class="d-flex flex-column">
                    <input type="text" value="17" class="text-center mb-2 bg-light border">
                    <input type="text" value="0" class="text-center mb-2 bg-light border">
                    <input type="text" value="17" class="text-center bg-light border">
                </div>
            </div>
        </div>
    </div>
